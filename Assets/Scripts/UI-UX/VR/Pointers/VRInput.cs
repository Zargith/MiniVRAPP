...
{
    [SerializeField] Camera eventCamera = null;
    [SerializeField] OVRInput.Button clickButton = OVRInput.Button.PrimaryIndexTrigger;
    [SerializeField] OVRInput.Controller controller = OVRInput.Controller.All;
